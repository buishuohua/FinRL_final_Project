...
class PPO(object):
	...
	def save(self,episode):
		torch.save(self.critic.state_dict(), "./ppo/ppo_critic{}.pth".format(episode))
		torch.save(self.actor.state_dict(), "./ppo/ppo_actor{}.pth".format(episode))


	def load(self,episode):
		self.critic.load_state_dict(torch.load("./ppo/ppo_critic{}.pth".format(episode)))
		self.actor.load_state_dict(torch.load("./ppo/ppo_actor{}.pth".format(episode)))